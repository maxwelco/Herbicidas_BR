...
olericolas <- nd %>% 
  ...
  mutate(class = ifelse(culturas == "alho" | culturas == "batata" | culturas == "batata-doce" | culturas == "batata_yacon" | culturas == "beterraba" | culturas == "cebola" | culturas == "cenoura" | culturas == "inhame" | culturas == "mandioquinha-salsa" | culturas == "mandioca" | culturas == "nabo" | culturas == "rabanete", "tuberosa", 
         ifelse(culturas == "alface" | culturas == "alfafa" | culturas == "brocolis" | culturas == "couve-flor" | culturas == "escarola" | culturas == "espinafre" | culturas == "coentro" | culturas == "repolho" | culturas == "salsa", "herbácea", 
                ifelse(culturas == "ervilha" | culturas == "gengibre" | culturas == "berinjela" | culturas == "jiló" | culturas == "lentilha" | culturas == "melancia" | culturas == "melão" | culturas == "morango" | culturas == "pimenta" | culturas == "pimentão" | culturas == "quiabo" | culturas == "tomate", "fruto", NA))))
...
oler <- olericolas  %>% 
  ...
  theme_bw() + 
    ...
    geom_label_repel(data = subset(oler, Freq > 50 & class == "tuberosa"), aes(label=culturas),
                box.padding   = 0.35, nudge_y = 3,
                  point.padding = 0.8,
                  segment.color = 'red', size=4, fill="white") +
    geom_label_repel(data = subset(oler, Freq > 20 & class == "fruto"), aes(label=culturas),
                box.padding   = 0.35, nudge_y = 3,
                  point.padding = 0.8,
                  segment.color = 'red', size=4, fill="white") +
    geom_label_repel(data = subset(oler, Freq > 10 & class == "herbácea"), aes(label=culturas),
...
oler_1 <- olericolas  %>% 
  ...
  ggsave("Olericolas_IA.pdf", dpi=600)
```
